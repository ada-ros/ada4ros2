...
limited with rclx.rmw_names_and_types_h;

package rclx.rmw_get_topic_names_and_types_h is
  ...
  --  
   ...
   function rmw_get_topic_names_and_types
     (node : access constant rclx.rmw_types_h.rmw_node_t;
      allocator : access rclx.rcutils_allocator_h.rcutils_allocator_t;
      no_demangle : Extensions.bool;
      topic_names_and_types : access rclx.rmw_names_and_types_h.rmw_names_and_types_t) return rclx.rmw_types_h.rmw_ret_t;  -- /home/jano/local/ros2/ros2_rolling/install/include/rmw/get_topic_names_and_types.h:77
   pragma Import (C, rmw_get_topic_names_and_types, "rmw_get_topic_names_and_types");

end rclx.rmw_get_topic_names_and_types_h;
