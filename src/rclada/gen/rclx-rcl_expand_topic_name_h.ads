...
limited with rclx.rcutils_types_string_map_h;
with rclx.rcl_allocator_h;
with System;
with rclx.rcl_types_h;

package rclx.rcl_expand_topic_name_h is
  ...
  --  
   ...
   function rcl_expand_topic_name
     (input_topic_name : Interfaces.C.Strings.chars_ptr;
      ...
      substitutions : access constant rclx.rcutils_types_string_map_h.rcutils_string_map_t;
      allocator : rclx.rcl_allocator_h.rcl_allocator_t;
      output_topic_name : System.Address) return rclx.rcl_types_h.rcl_ret_t;  -- /home/jano/local/ros2/ros2_rolling/install/include/rcl/expand_topic_name.h:117
  ...
  --  
   ...
   function rcl_get_default_topic_name_substitutions (string_map : access rclx.rcutils_types_string_map_h.rcutils_string_map_t) return rclx.rcl_types_h.rcl_ret_t;  -- /home/jano/local/ros2/ros2_rolling/install/include/rcl/expand_topic_name.h:138
   pragma Import (C, rcl_get_default_topic_name_substitutions, "rcl_get_default_topic_name_substitutions");

end rclx.rcl_expand_topic_name_h;
