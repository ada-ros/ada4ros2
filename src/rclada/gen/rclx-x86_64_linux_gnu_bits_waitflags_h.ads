...
package rclx.x86_64_linux_gnu_bits_waitflags_h is
  ...
  -- Wait for members of process group.   
   type idtype_t is 
     (P_ALL,
      P_PID,
      P_PGID);
   pragma Convention (C, idtype_t);  -- /usr/include/x86_64-linux-gnu/bits/waitflags.h:57

end rclx.x86_64_linux_gnu_bits_waitflags_h;
